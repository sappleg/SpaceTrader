...
public class LocalPlanetPresenter {
    ...
    private void setListeners() {
        ...
        localPlanetView.btnTravel.addMouseListener(new MouseAdapter() {
            public void mouseUp(MouseEvent e) {
                /*
                 * get selection from local planets list get players x y
                 * calculate distance difference calculate fuel needed check
                 * that player has necessary fuel change player location update
                 * player vitals update market update local planet list update
                 * ss stats
                 */

                if (LocalPlanetView.list_2.getSelection().length == 0) {
                    NotificationsView.list_1
                            .add("Please select an solar system from the list");
                ...
                if (fuelNeeded > playerFuel) {
                    NotificationsView.list_1
                            .add("You do not have enough fuel to travel here");
                    NotificationsView.list_1.select(NotificationsView.list_1
                            .getItemCount() - 1);
                    NotificationsView.list_1.showSelection();
                    return;
                ...
                // updating UI information since you have traveled.
                    ...
                    if (randomEvent >= 50 && randomEvent <= 69) {
                        ...
                        int narcoticsAmt = currentShip
                                .countCargo(GoodType.NARCOTIC);
                        currentShip
                                .removeCargo(narcoticsAmt, GoodType.NARCOTIC);
                        NotificationsView.list_1
                                .add("You got pulled over by Space Police who checked for and removed any and all illegal cargo");
                        NotificationsView.list_1
                        ...
                        NotificationsView.list_1
                                .add("You were raided by pirates! They cleaned you out of all your cargo.");
                        NotificationsView.list_1
                                .select(NotificationsView.list_1.getItemCount() - 1);
                        NotificationsView.list_1.showSelection();
                    }
                        ...
                        NotificationsView.list_1
                                .add("You picked up a stranded merchant and took him to the nearest planet. He gave you 1000 credits for your troubles.");
                        NotificationsView.list_1
                                .select(NotificationsView.list_1.getItemCount() - 1);
                        NotificationsView.list_1.showSelection();
                    }
                        ...
                        NotificationsView.list_1
                                .add("During your travels a wormhole suddenly appeared. You flew through the wormhole and used no fuel.");
                        NotificationsView.list_1
                                .select(NotificationsView.list_1.getItemCount() - 1);
                        NotificationsView.list_1.showSelection();
                    }
                        ...
                        NotificationsView.list_1
                                .add("While approaching the planet your gas tank was suddenly struck by an meteorite. Your remaining fuel was drained as a result.");
                        NotificationsView.list_1
                                .select(NotificationsView.list_1.getItemCount() - 1);
                        NotificationsView.list_1.showSelection();
                        ...
                        // treasure encounter, 1000*(1..10) credits are added to
                        // currency
                        ...
                        Driver.Player.setCurrency(newCurrency);
                        NotificationsView.list_1
                                .add("You found a pirates treasure cash! You recieved "
                                        + reward + " credits.");
                        NotificationsView.list_1
                                .select(NotificationsView.list_1.getItemCount() - 1);
                        NotificationsView.list_1.showSelection();
                        ...
                        NotificationsView.list_1
                                .add("Nothing interesting happened on your travels.");
                        NotificationsView.list_1
                                .select(NotificationsView.list_1.getItemCount() - 1);
                        NotificationsView.list_1.showSelection();
                    }

                    Driver.CurrentSystem = Driver.Player.findSystem(
                            Driver.Player.getPlayerX(),
                            Driver.Player.getPlayerY());
                    NotificationsView.list_1.add("You have moved to planet: "
                            + Driver.CurrentSystem.getSystemName());
                    NotificationsView.list_1.add("Fuel Consumed Traveling: "
                            + fuelNeeded);
                    NotificationsView.list_1.select(NotificationsView.list_1
                            .getItemCount() - 1);
                    NotificationsView.list_1.showSelection();
    ...
    public static void setNewLocals() {
        ...
        for (int i = 0; i < Driver.ListOfSystems.size(); i++) {
            ...
            int distance = (int) ((Math.pow(playerX - sysX, 2)) + (Math.pow(
                    playerY - sysY, 2)));
            distance = (int) (Math.sqrt(distance));
