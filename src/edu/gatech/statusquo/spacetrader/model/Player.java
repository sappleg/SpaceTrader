...
public class Player {
     ...
     * 
     * @param curr
     *            an integer that is the amount of money.
     */
     ...
     * 
     * @param i
     *            represents the engineer skills
     */
    ...
    public String toString() {
        return name + "," + Integer.toString(currency) + ","
                + Integer.toString(trader) + "," + Integer.toString(engineer)
                + "," + Integer.toString(fighter) + ","
